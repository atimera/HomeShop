package com.opc.amdiatou.homeshop.web;

import com.opc.amdiatou.homeshop.Fridge;
import com.opc.amdiatou.homeshop.Product;
import com.opc.amdiatou.homeshop.Television;
...
public class BillServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(req.getQueryString() == null) // no parameter
            displayForm(resp);
        else
            displayBill();
    }
